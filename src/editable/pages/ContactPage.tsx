...
const tone = {
  ...
  panel: 'border border-[var(--editable-border)] bg-[var(--slot4-surface-bg)] shadow-[0_22px_60px_rgba(94,0,6,0.08)]',
  soft: 'border border-[var(--editable-border)] bg-[var(--slot4-panel-bg)] shadow-[0_16px_40px_rgba(94,0,6,0.05)]',
      ...
      <main className="mx-auto max-w-[var(--editable-container)] px-4 py-14 sm:px-6 lg:px-8">
        <section className="grid gap-8 lg:grid-cols-[0.95fr_1.05fr] lg:items-start">
          <div>
            ...
            <h1 className="editable-display mt-4 text-5xl font-semibold tracking-[-0.06em] sm:text-6xl">{pagesContent.contact.title}</h1>
