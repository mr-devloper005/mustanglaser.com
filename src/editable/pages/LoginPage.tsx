      ...
      <main className="bg-[var(--slot4-panel-bg)] text-[var(--slot4-page-text)]">
        <section className="mx-auto grid min-h-[calc(100vh-12rem)] max-w-[var(--editable-container)] items-center gap-12 px-4 py-16 sm:px-6 lg:grid-cols-[1fr_0.9fr] lg:px-8">
          <div>
            ...
            <h1 className="editable-display mt-4 max-w-xl text-5xl font-semibold leading-[0.94] tracking-[-0.06em] sm:text-6xl">{pagesContent.auth.login.title}</h1>
          ...
          <div className="rounded-[2rem] border border-[var(--editable-border)] bg-[var(--slot4-surface-bg)] p-7 shadow-[0_22px_60px_rgba(94,0,6,0.08)] sm:p-9">
            <h2 className="editable-display text-2xl font-semibold tracking-[-0.04em]">{pagesContent.auth.login.formTitle}</h2>
